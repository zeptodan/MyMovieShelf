...
const Navbar = () => {
    ...
    return (
        <nav className=' font w-screen h-16 bg-blue-950 text-white flex items-center justify-between px-4 shadow-lg'>
            ...
            <div className='flex space-x-4'>
                {isAuthenticated ? 
                    <div className='relative mr-4 md:mr-12' onMouseEnter={()=> window.innerWidth > 768 && setIsOpen(true)} onMouseLeave={()=> window.innerWidth > 768 && setIsOpen(false)}>
                        ...
                        {isOpen && <div className='absolute flex flex-col items-center bg-blue-950 rounded-b-sm p-4 right-1/2 translate-x-1/2 space-y-2 shadow-lg'>
